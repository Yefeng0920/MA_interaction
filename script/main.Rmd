...
pE_1 <- orchard_plot(resultsE_1,
             ...
             xlab = "OA effect at multiplicative scale", flip = T, angle = 50) +
...
p_12 <- orchard_plot(results_1,
             trunk.size = 0.3, branch.size = 2,
             xlab = "Multiplicative effect size (LnRR)", flip = T, angle = 70) +
  labs(title = "Across species") +
  theme(axis.text.x = element_text(size = 16),
        ...
        axis.ticks.y = element_blank()) +
  scale_x_discrete(labels = c("Overall","Primary producer","Herbivore","Meso-predator","Top-predator"))

png(filename = here("figure", "figure1.png"), width = 14, height = 14, units = "in", type = "windows", res = 400)
  p_1 + p_12 + p_12 +
  p_1 + p_12 + p_12 +
  p_1 + p_12 + p_12 + plot_layout(nrow = 3, ncol = 3) + plot_annotation(tag_levels = list(c('A', 'B', 'C', 'D', 'E', 'F', "G", "H", "I"))) & theme(plot.tag = element_text(size = 14, face = "bold"))
dev.off()
...
# layout
  png(filename = here("figure", "figure1.png"), width = 15, height = 16, units = "in", type = "windows", res = 400)
  pE_1 + pE_1 + pE_1 +
  pE_2 + pE_2 + pE_2 +
  pE_3 + pE_3 + pE_3 +
  pE_4 + pE_4 + pE_4 + plot_layout(nrow = 4, ncol = 3) + plot_annotation(tag_levels = list(c('A', 'B', 'C', 'D', 'E', 'F', "G", "H", "I", "J", "K", "L"))) & theme(plot.tag = element_text(size = 16, face = "bold"))
dev.off()
  
## additional moderator
rma.mv(yi = lnRR_E, V = V_0.5_E, mods = ~ BiologicalResponses - 1, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")


str_TL_E_N <- rma.mv(yi = lnRR_E, V = V_0.5_E, mods = ~ Ne_OA, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

bubble_plot(str_TL_E_N, mod = "Ne_OA", group = "StudyID", xlab = "N")

str_TL_E_Year <- rma.mv(yi = lnRR_E, V = V_0.5_E, mods = ~ Year, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

bubble_plot(str_TL_E_Year, mod = "Year", group = "StudyID", xlab = "Year")
...
pS_1 <- orchard_plot(resultsS_1,
             trunk.size = 0.3, branch.size = 2, alpha = 0.3,
             xlab = "OW effect at multiplicative scale", flip = T, angle = 50) +
  labs(title = "Across species") +
  theme(axis.text.x = element_text(size = 16),
        axis.text.y = element_text(size = 16),
        axis.title = element_text(size = 16),
...
## additional moderator
rma.mv(yi = lnRR_S, V = V_0.5_S, mods = ~ BiologicalResponses - 1, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

str_TL_S_N <- rma.mv(yi = lnRR_S, V = V_0.5_S, mods = ~ Ne_OW, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

bubble_plot(str_TL_S_N, mod = "Ne_OW", group = "StudyID", xlab = "N")


str_TL_S_Year <- rma.mv(yi = lnRR_S, V = V_0.5_S, mods = ~ Year, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

bubble_plot(str_TL_S_Year, mod = "Year", group = "StudyID", xlab = "Year")
...
pES_1 <- orchard_plot(resultsES_1,
             trunk.size = 0.3, branch.size = 2, alpha = 0.3,
             xlab = "OA×OW effect at multiplicative scale", flip = T, angle = 50) +
  labs(title = "Across species") +
  theme(axis.text.x = element_text(size = 16),
        axis.text.y = element_text(size = 16),
        axis.title = element_text(size = 16),
...
## additional moderator
rma.mv(yi = lnRR_ES, V = V_0.5_ES, mods = ~ BiologicalResponses - 1, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

str_TL_ES_N <- rma.mv(yi = lnRR_ES, V = V_0.5_ES, mods = ~ Ne_interaction, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

bubble_plot(str_TL_ES_N, mod = "Ne_interaction", group = "StudyID", xlab = "N")


str_TL_ES_Year <- rma.mv(yi = lnRR_ES, V = V_0.5_ES, mods = ~ Year, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

bubble_plot(str_TL_ES_Year, mod = "Year", group = "StudyID", xlab = "Year")
...
orchard_plot(str_TL_E2_fig2, mod = "TrophicLevel", group = "StudyID",
                          trunk.size = 0.3, branch.size = 2,
                            xlab = "Effect size (SMD)", flip = FALSE)
...
## estimates of different Calcifier - fig 3
str_TL_E2_fig3 <- rma.mv(yi = SMD_E, V = V_0.5_E, mods = ~ Calcifier - 1, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

orchard_plot(str_TL_E2_fig3, mod = "Calcifier", group = "StudyID",
                          trunk.size = 0.3, branch.size = 2,
                            xlab = "Effect size (SMD)", flip = FALSE)
...
p_mod_fig5_E <- orchard_plot(str_TL_E2_fig5, mod = "Region2", group = "StudyID",
                          trunk.size = 0.3, branch.size = 2,
                            xlab = "Effect size (SMD)", flip = FALSE)
...
## additional moderator
rma.mv(yi = SMD_E, V = V_0.5_E, mods = ~ BiologicalResponses - 1, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")
...
## estimates of different TrophicLevel - fig 2
str_TL_S2_fig2 <- rma.mv(yi = SMD_S, V = V_0.5_S, mods = ~ TrophicLevel - 1, 
                     random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")
...
p_mod_fig3_S
## estimates of different Region2 - fig 5
str_TL_S2_fig5 <- rma.mv(yi = SMD_S, V = V_0.5_S, mods = ~ Region2 - 1, 
                    random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")
...
## additional moderator
rma.mv(yi = SMD_S, V = V_0.5_S, mods = ~ BiologicalResponses - 1, 
                    random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")
...
## estimates of different TrophicLevel - fig 2
str_TL_ES2_fig2 <- rma.mv(yi = SMD_ES, V = V_0.5_ES, mods = ~ TrophicLevel - 1, 
                     random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")
...
## additional moderator
rma.mv(yi = SMD_ES, V = V_0.5_ES, mods = ~ BiologicalResponses - 1, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")


str_TL_ES2_N <- rma.mv(yi = SMD_ES, V = V_0.5_ES, mods = ~ Ne_interaction, random = list(~1 | StudyID, ~1 | Effect_size_ID), data = dat, method = "REML")

bubble_plot(str_TL_ES2_N, mod = "Ne_interaction", group = "StudyID", xlab = "N")
```
